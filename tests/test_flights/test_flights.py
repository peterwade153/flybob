...
class FlightTestCase(unittest.TestCase):
    ...
    def test_register_flight(self):
        ...
        result = self.app.post('/api/v1/flights', data=json.dumps(self.flight_data), headers={
    ...
    def test_register_flight_with_incomplete_data(self):
        ...
        result = self.app.post('/api/v1/flights', data=json.dumps(incomplete_data), headers={
                    'Content-Type':'application/json',
                    'Authorization':token})
    ...
    def test_get_all_flights(self):
        ...
        result = self.app.post('/api/v1/flights', data=json.dumps(self.flight_data), headers={
                    ...
                    'Authorization':token})
        self.assertEqual(result.status_code, 201)
        res = self.app.get('/api/v1/flights', headers={
                    'Content-Type':'application/json',
                    'Authorization':token})
    ...
    def test_update_flight(self):
        res = self.app.post('/api/v1/auth/login', data=json.dumps(self.user_data),
                        headers={'Content-Type':'application/json'})
        token = json.loads(res.data.decode())['access_token']
        self.app.post('/api/v1/flights', data=json.dumps(self.flight_data), headers={
                    'Content-Type':'application/json',
                    'Authorization':token})
        update_data = {
            "name": "KQ-FTK123", 
        ...
        result = self.app.put('/api/v1/flights/1', data=json.dumps(update_data), headers={
                    'Content-Type':'application/json',
                    'Authorization':token})
    ...
    def test_update_non_existing_flight(self):
        ...
        result = self.app.put('/api/v1/flights/3', data=json.dumps(update_data), headers={
                    'Content-Type':'application/json',
                    'Authorization':token})
    ...
    def test_delete_flight(self):
        ...
        self.app.post('/api/v1/flights', data=json.dumps(self.flight_data), headers={
                    'Content-Type':'application/json',
                    'Authorization':token})
        result = self.app.delete('/api/v1/flights/1', headers={
                    'Content-Type':'application/json',
                    'Authorization':token})
        self.assertEqual(result.status_code, 200)
    ...
    def test_delete_non_existing_flight(self):
        res = self.app.post('/api/v1/auth/login', data=json.dumps(self.user_data),
                        headers={'Content-Type':'application/json'})
        token = json.loads(res.data.decode())['access_token']
        result = self.app.delete('/api/v1/flights/6', headers={
                    'Content-Type':'application/json',
                    'Authorization':token})
        self.assertEqual(result.status_code, 404)
    ...
    def test_get_flight(self):
        ...
        result = self.app.post('/api/v1/flights', data=json.dumps(self.flight_data), headers={
                    ...
                    'Authorization':token})
        self.assertEqual(result.status_code, 201)
        res = self.app.get('/api/v1/flights/1', headers={
                    'Content-Type':'application/json',
                    'Authorization':token})
        self.assertEqual(res.status_code, 200)
