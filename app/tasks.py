...
def flight_reminder():
    with app.app_context():
        ...
        for booking in tomorrow_flights:
            ...
            mail_send(subject = "Reminder about flight "+str(flight.name),
                     recipients = [user.email],
                     text_body = "Hello "+user.username+" This is to remind you that flight "+flight.name+
                                 " you booked, will be departing tomorrow for "+flight.destination+".")
